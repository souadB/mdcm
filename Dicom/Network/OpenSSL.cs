...
namespace Dicom.Network {
	...
	public class OpenSslCertificate : IDisposable {
	...
	public class OpenSslPrivateKey : IDisposable {
		#region Private Members
	...
	public class OpenSslContext : IDisposable {
		#region Private Members
		private IntPtr _ctx;
		#endregion
	...
	public class OpenSslConnection : IDisposable {
		#region Private Members
		private IntPtr _ssl;
	...
	public class OpenSslBIO : IDisposable {
		#region Private Members
		private IntPtr _bio;
		#endregion
	...
	public static class OpenSslUtility {
		#region Methods
